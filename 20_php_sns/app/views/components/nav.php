...
<?php if (isset($auth_user)): ?>
    <nav id="side-menu" class="flex h-full flex-col gap-1 p-2 xl:p-4">
        ...
        <a href="<?= BASE_URL ?>home/" class="flex items-center justify-center gap-0 rounded-xl px-3 py-3 font-semibold text-slate-800 transition hover:bg-sky-50 xl:justify-start xl:gap-3">
            <img src="<?= BASE_URL ?>svg/home.svg" class="w-6 h-6 shrink-0">
            <span class="hidden xl:inline">ホーム</span>
        </a>

        <a href="<?= BASE_URL ?>home/garally.php" class="flex items-center justify-center gap-0 rounded-xl px-3 py-3 font-semibold text-slate-800 transition hover:bg-sky-50 xl:justify-start xl:gap-3">
