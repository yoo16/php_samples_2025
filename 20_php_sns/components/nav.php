...
<nav id="side-menu" class="flex flex-col gap-1 p-4 h-full">
    ...
    <a href="home/" class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-sky-50 text-slate-800 font-semibold transition">
        <img src="svg/home.svg" class="w-6 h-6 shrink-0">
        <span>ホーム</span>
    </a>
