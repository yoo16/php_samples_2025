 ...
 * 【手順】
 *   1. 空欄を埋めてください。
 *   2. ブラウザでこのファイルにアクセスして結果を確認してください。
 *   3. 「接続成功」と緑色で表示されれば完成です！
 *
 * 【ヒント】
...
// --------------------------------------------------------
// (1) 設定ファイルを読み込む
//     ヒント: require_once を使って './db.php' を読み込む
// --------------------------------------------------------
require_once '___';  // ← ここを完成させる

// --------------------------------------------------------
// (2) 接続成功かどうかを判定する
// --------------------------------------------------------
$is_connected = isset($pdo) && $pdo instanceof PDO; // 答え合わせ用
