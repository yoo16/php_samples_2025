...
<head>
    ...
    <style>
        ...
        /* スクロールバーのカスタマイズ */
        .sql-preview::-webkit-scrollbar { width: 8px; }
        .sql-preview::-webkit-scrollbar-track { background: #1e293b; }
        .sql-preview::-webkit-scrollbar-thumb { background: #475569; border-radius: 4px; }
    </style>
</head>
                ...
                <section class="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl border border-slate-800">
                    <div class="px-6 py-4 bg-slate-800 flex items-center justify-between">
                        <h3 class="text-slate-300 text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            <svg class="w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2 1.5 3 3.5 3H18c1 0 2-1 2-2V7c0-2-1.5-3-3.5-3H7c-2 0-3 1-3 3z"></path></svg>
