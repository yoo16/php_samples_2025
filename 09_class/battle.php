                ...
                <div class="flex flex-col md:flex-row gap-8 items-center md:items-end justify-end">
                    <div class="flex-1 w-full max-w-md text-right order-2 md:order-1">
                        ...
                        <div class="w-full bg-slate-900 h-4 rounded-full overflow-hidden border border-slate-800 p-0.5">
                            <div class="hp-bar bg-gradient-to-r from-rose-600 to-rose-400 h-full rounded-full transition-all duration-500" style="width: <?= getPercentage($enemy->hp, $enemy->maxHp) ?>%"></div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div class="flex-1 w-full max-w-md">
                        ...
                        <div class="w-full bg-slate-900 h-4 rounded-full overflow-hidden border border-slate-800 p-0.5 shadow-inner">
                            <div class="hp-bar bg-gradient-to-r from-emerald-600 to-emerald-400 h-full rounded-full transition-all duration-500" style="width: <?= getPercentage($player->hp, $player->maxHp) ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
